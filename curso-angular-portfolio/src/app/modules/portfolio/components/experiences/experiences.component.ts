...
export class ExperiencesComponent {
  public arrayExperiences = signal<IExperiences[]>([
    ...
    },
    {
      ...
      text: '- Liderança da equipe de Tecnologia (Backend e Frontend).<br />- Tive uma visão estratégica para melhorar as condições de trabalho da equipe, buscando criar um ambiente produtivo, motivador e colaborativo. Isso incluiu a identificação de oportunidades de aprimoramento nos processos internos, a implementação de boas práticas e a promoção de uma cultura de inovação.<br />- Desenvolvi e ministrei treinamentos para os estagiários da equipe, compartilhando conhecimentos e habilidades técnicas, bem como orientando-os no desenvolvimento de suas competências profissionais. <br />- Desenvolvimento de portais, sites e hotsites para diversos clientes. Utilizando HTML, CSS, JQUERY, C#<br />- Desenvolvimento de aplicações nas Mídias Sociais (Facebook e Twitter).<br />- Desenvolvimento de orçamentos para o desenvolvimento de Frontend.<br />- Desenvolvimento de E-mails Marketing.<br />- Manutenções pontuais em alguns projetos.',
    },
    {
      summary: {
      ...
      text: '- Desenvolver código frontend em HTML/CSS/Jquery do e-commerce e de e-mail marketing. <br />- Desenvolver código frontend em HTML/CSS/Jquery de hotsites para clientes, como: Philips, Acer, Samsung, Sony, entre outros.',
    },
    {
      summary: {
        strong: 'Frontend Developer',
      ...
      text: '- Desenvolver código frontend em HTML/CSS/Jquery<br />- Desenvolver código frontend de newsletter e e-mail marketing.<br />- Principais clientes: Banco do Brasil, Mantecorp, Cyrela, Ecorodovias, Officer, Grupo Orsa, Guaraná Antarctica, Grupo Pão de Açúcar, entre outros.',
    },
  ]);
}
